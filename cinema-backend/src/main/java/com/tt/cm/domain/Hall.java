...
public class Hall implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Hall hall = (Hall) o;
        return Objects.equals(cinemaId, hall.cinemaId) && Objects.equals(hallId, hall.hallId) && Objects.equals(hallName, hall.hallName) && Objects.equals(hallCategory, hall.hallCategory) && Objects.equals(rowStart, hall.rowStart) && Objects.equals(rowNums, hall.rowNums) && Objects.equals(seatNumsRow, hall.seatNumsRow) && Objects.equals(seatNums, hall.seatNums) && Objects.equals(seatState, hall.seatState) && Objects.equals(delState, hall.delState) && Objects.equals(cinema, hall.cinema);
    }

    @Override
    public int hashCode() {
        return Objects.hash(cinemaId, hallId, hallName, hallCategory, rowStart, rowNums, seatNumsRow, seatNums,
                seatState, delState, cinema);
    }
